...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbw5HBNL9iHRT296NSNG4030rQpj_FGKv7ZmEBj1ESAluAJSqfEc_eQFVKCel-GpWNWQWQ/exec";
...
// Girls left blank — Franklin doesn't have a co-leader yet. Once one is
  ...
  return (
    <div className="home-wrap">
      <div className="home-hero">
        <span className="eyebrow">Franklin Flores' Cell Report</span>
    ...
    <div className="shell" data-textsize={textSize}>
      ...
      <header className="topbar">
        <button className="brand" onClick={goHome}>
          ...
          <span className="brand-name">Franklin Flores' Cell Report</span>
        </button>
